...
//        EquiposAdapter equiposAdapter = new EquiposAdapter(this, );
...
class  EquiposAdapter extends ArrayAdapter<String>{

    Context context;
    String nombre[];

    EquiposAdapter (Context c, String nombre[]){
        super(c, R.layout.equipos_viewholder, nombre);
        this.context = c;
        this.nombre = nombre;
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View view = layoutInflater.inflate(R.layout.equipos_viewholder, parent, false);

        TextView textViewNombre = view.findViewById(R.id.textViewNombreEquipo);
